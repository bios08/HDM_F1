...
function tower_mountain:update_game(game)
...
--Quest Log
    ...
    --[[ --COMENTO ESTO, YA QUE ESTO ES POR LAS QUEST DEL PROYECTO DE OCEAN
...
function tower_mountain:on_draw(dst_surface)
